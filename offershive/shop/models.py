...
class Product(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return reverse("product_detail", kwargs={'slug': self.slug})      # product_detail - name of product detail  url

    class Meta:
        db_table = "shop_Product"          # app -shop   model -Produce
...
class Moving_text(models.Model):
    code = models.ForeignKey(Coupon_code, on_delete=models.CASCADE, null=True,blank=True)
